...
import { Size, CancelEventArgs, ObservableArray, Point, Rect, DataType, NotifyCollectionChangedEventArgs, Aggregate, Control, Event, EventArgs, ICollectionView, Tooltip, Binding, IEditableCollectionView } from 'wijmo/wijmo';
...
export declare class _SelectionHandler {
     ...
     */
    readonly extendedSelection: ObservableArray;
    /**
 ...
 */
export declare class RowColCollection extends ObservableArray {
    _g: FlexGrid;
    _frozen: number;
    _lastFrozen: number;
...
export declare class FlexGrid extends Control {
    ...
    */
     ...
     * to word-wrap their content (see {@link Col.wordWrap}), and when the grid
     ...
     *
     * To export the current selection, set the {@link rng} parameter to null.
    ...
    selectedItems: any[];
    /**
     * Gets an array with {@link CellRange} objects that represent
     ...
     * ranges that represent the extended collection.
     *
     ...
     */
    readonly starSizedColumns: Event;
    /**
...
export declare class _EditHandler {
     ...
     */
    getClipString(rng?: CellRange, csv?: boolean, colHdrs?: boolean, rowHdrs?: boolean): string;
    _getRowClipString(p: GridPanel, r: number, rng: CellRange, csv: boolean, rh: boolean): string;
