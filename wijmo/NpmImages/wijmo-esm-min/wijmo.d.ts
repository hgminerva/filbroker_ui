...
export declare class NotifyCollectionChangedEventArgs extends EventArgs {
     ...
     */
    static reset: selfModule.NotifyCollectionChangedEventArgs;
    /**
 ...
 */
export declare function getTypes(arr: any[]): any[];
/**
 ...
 *
 * The {@link glbz} tag function allows you to specify formatting for variables
 * in template literal expressions. For example:
 *
 * var msg = glbz`this is the number: $<span/>{theNumber}:n2!`;
 */
...
export declare class Globalize {
     ...
     *
     * <pre>Globalize.formatNumber(value, '"thousands: "c3," k"');
     * Globalize.formatNumber(value, '"millions: "c1,," M"');</pre>
     *
 ...
 */
export declare class ArrayBase extends Array<any> {
    /**
...
export declare class ObservableArray extends ArrayBase implements INotifyCollectionChanged {
     ...
     * Occurs when the collection changes.
     */
    readonly collectionChanged: selfModule.Event;
    /**
...
export declare class CollectionView implements IEditableCollectionView, IPagedCollectionView {
     ...
     */
    onCollectionChanged(e?: selfModule.NotifyCollectionChangedEventArgs): void;
    protected _raiseCollectionChanged(action?: selfModule.NotifyCollectionChangedAction, item?: any, index?: number): void;
    protected _notifyItemChanged(item: any): void;
    /**
     * Occurs before the value of the {@link sourceCollection} property changes.
     */
    readonly sourceCollectionChanging: selfModule.Event;
    /**
     ...
     */
    readonly sourceCollectionChanged: selfModule.Event;
    /**
     ...
     * Occurs after the current item changes.
     */
    readonly currentChanged: selfModule.Event;
    /**
     * Raises the {@link currentChanged} event.
     */
    onCurrentChanged(e?: selfModule.EventArgs): void;
    /**
     * Occurs before the current item changes.
     */
    readonly currentChanging: selfModule.Event;
    /**
    ...
    */
     ...
     */
    onPageChanged(e?: selfModule.EventArgs): void;
    /**
     * Occurs before the page index changes.
     */
