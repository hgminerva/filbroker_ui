...
import { Row, MergeManager, GridPanel, CellRange, FlexGrid, _AddNewHandler, CellRangeEventArgs, Column, FormatItemEventArgs, ColumnCollection } from 'wijmo/wijmo.grid';
import { Event, EventArgs, CancelEventArgs, NotifyCollectionChangedEventArgs } from 'wijmo/wijmo';
/**
