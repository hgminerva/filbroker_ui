...
import { Control, EventArgs, ObservableArray, NotifyCollectionChangedEventArgs, ICollectionView } from 'wijmo/wijmo';
...
export declare class GroupPanel extends Control {
    ...
    _removeGroup(index: number, groups?: ObservableArray): void;
