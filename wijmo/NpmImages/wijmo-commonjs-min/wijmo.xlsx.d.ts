 ...
 * with a reference to the JSZip module using the {@link useJSZip} function, with a code like shown below:
 * <pre>import * as JSZip from 'jszip';
 * import * as wjcXlsx from 'wijmo/wijmo.xlsx';
 * wjcXlsx.useJSZip(JSZip);
 * </pre>
 *
 * It's enough to call the {@link useJSZip} function only once per application page, and the best place to do it
