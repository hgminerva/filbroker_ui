...
import { CancelEventArgs, Control, Event } from 'wijmo/wijmo';
...
export declare class UndoStack {
     ...
     */
    readonly addingTarget: Event;
    /**
     * Raises the {@link addingTarget} event.
     *
     * @param e {@link AddingTargetEventArgs} that contains the event data.
