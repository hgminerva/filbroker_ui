...
export class ChecklistService {
    ...
    public addChecklist(checklist : MstChecklist, btnAddChecklist: Element) : void {
        let url="http://localhost:10136/api/MstCheckList/Add";
    ...
    public deleteChecklist(id : number) : void {
        let url="http://localhost:10136/api/MstCheckList/Delete/" + id;
    ...
    public getChecklist(id : number) : void {
        ...
        let url="http://localhost:10136/api/MstCheckList/Detail/" + id;
    ...
    public saveChecklist(checklist : MstChecklist) : void {
        let url="http://localhost:10136/api/MstCheckList/Save";
    ...
    public lockChecklist(checklist : MstChecklist) : void{
        let url="http://localhost:10136/api/MstCheckList/Lock";
        this.http.put(url,JSON.stringify(checklist),this.options).subscribe(
            response=>{
    ...
    public unlockChecklist(checklist : MstChecklist) : void{
        let url="http://localhost:10136/api/MstCheckList/UnLock";
        this.http.put(url,JSON.stringify(checklist),this.options).subscribe(
            reponse=>{
    ...
    public getChecklistRequirementsPerChecklist(id : number) {
        let url = "http://localhost:10136/api/MstCheckListRequirement/ListPerChecklist/" + id;
    ...
    public saveChecklistRequirement(checklistRequirement: MstChecklistRequirement): void {
        if(checklistRequirement.id == 0) {
            let url = "http://localhost:10136/api/MstCheckListRequirement/Add";
            ...
            let url = "http://localhost:10136/api/MstCheckListRequirement/Save";
    ...
    public deleteChecklistRequirement(id: number) {
        let url = "http://localhost:10136/api/MstCheckListRequirement/Delete/" + id;
        this.http.delete(url, this.options).subscribe(
            response => {
