...
export class UserService {
    ...
    public getUser(id: number) {
        let user: MstUser;
        // let url = "http://localhost:10136/api/MstUser/Detail/" + id;
        let url = "http://localhost:10136/api/MstUser/Detail/" + id;
    ...
    public saveUser(user: MstUser): void {
        // let url = "http://localhost:10136/api/MstUser/Save";
        let url = "http://localhost:10136/api/MstUser/Save";
    ...
    public getUserRightsPerUser(id: number): void {
        // let url = "http://localhost:10136/api/MstUserRight/ListPerUser/" + id;
        let url = "http://localhost:10136/api/MstUserRight/ListPerUser/" + id;
    ...
    public saveUserRight(userRight: MstUserRight): void {
        if(userRight.id == 0) {
            // let url = "http://localhost:10136/api/MstUserRight/Add";
            let url = "http://localhost:10136/api/MstUserRight/Add";
            ...
            // let url = "http://localhost:10136/api/MstUserRight/Save";
            let url = "http://localhost:10136/api/MstUserRight/Save";
    ...
    public deleteUserRight(id: number) {
        // let url = "http://localhost:10136/api/MstUserRight/Delete/" + id;
        let url = "http://localhost:10136/api/MstUserRight/Delete/" + id;
    ...
    // detail line1 combo boxes
    public getPages() {
        // let url = "http://localhost:10136/api/SysPage/List";
        let url = "http://localhost:10136/api/SysPage/List";
