...
export class CommissionService {
    ...
    public getCommissionsPerDates(dateStart: string, dateEnd: string): void {
        let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCommissionRequest/ListPerDates/" + dateStart + "/" + dateEnd;
    ...
    public getCommission(id : number) : void {
        ...
        let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCommissionRequest/Detail/" + id;
    ...
    public getSoldUnits(): void {
        let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnSoldUnit/List";
    ...
    public addCommission(commission: TrnCommissionRequest, btnAddCommission: Element) : void {
        let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCommissionRequest/Add";
    ...
    public deleteCommission(id: number) : void {
        let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCommissionRequest/Delete/" + id;
    ...
    public saveCommission(commission: TrnCommissionRequest): void {
        let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCommissionRequest/Save";
    ...
    public lockCommission(commission: TrnCommissionRequest): void {
        let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCommissionRequest/Lock";
        this.http.put(url, JSON.stringify(commission), this.options).subscribe(
            response => {
    ...
    public unlockCommission(commission: TrnCommissionRequest): void {
        let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCommissionRequest/Unlock";
        this.http.put(url, JSON.stringify(commission), this.options).subscribe(
            response => {
