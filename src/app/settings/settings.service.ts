...
export class SettingsService {
    ...
    public getSettings(): void {
        ...
        let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/SysSettings/Detail";
    ...
    public saveSettings(settings: SysSettings): void {
        let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/SysSettings/Save";
    ...
    public deleteDropDowns(id: number): void {
        let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/SysDropDown/Delete/" + id;
    ...
    public saveDropDowns(dropDown: SysDropDown): void {
        if(dropDown.id == 0) {
            let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/SysDropDown/Add";
            ...
            let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/SysDropDown/Save";
