...
export class CollectionService {
  ...
  public getCollectionList(dateStart: string, dateEnd: string): void {
    ...
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollection/CollectionFillterByDate/" + dateStart + "/" + dateEnd;
  ...
  public addCollection(btnAddCollection: Element): void {
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollection/Add";
  ...
  public deleteCollection(id: number): void {
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollection/Delete/" + id;
  ...
  public getCustomers(): void {
    ...
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollection/CustomerList";
    this.http.get(url, this.options).subscribe(
      response => {
        var results = new ObservableArray(response.json());
        if (results.length > 0) {
  ...
  public getSoldUnits(customerId: number): void {
    ...
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollectionPayment/SoldUnits/" + customerId;
    this.http.get(url, this.options).subscribe(
      response => {
        var results = new ObservableArray(response.json());
        if (results.length > 0) {
  ...
  public getSysDropDown(): void {
    ...
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollectionPayment/SysDropDown";
    this.http.get(url, this.options).subscribe(
      response => {
        var results = new ObservableArray(response.json());
        if (results.length > 0) {
  ...
  public getUsers(): void {
    ...
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollection/UserList";
    this.http.get(url, this.options).subscribe(
      response => {
        var results = new ObservableArray(response.json());
        if (results.length > 0) {
  ...
  public getCollectionDetail(id: number) {
    ...
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollection/Detail/" + id;
    this.http.get(url, this.options).subscribe(
      response => {
  ...
  public saveCollection(collection: TrnCollectionModel): void {
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollection/Save";
  ...
  public lockCollection(collection: TrnCollectionModel): void {
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollection/Lock";
    this.http.put(url, JSON.stringify(collection), this.options).subscribe(
      response => {
  ...
  public unLockCollection(collection: TrnCollectionModel): void {
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollection/UnLock";
    this.http.put(url, JSON.stringify(collection), this.options).subscribe(
      response => {
  ...
  public getCollectionPayments(collectionId: number): void {
    ...
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollectionPayment/CollectionPayment/" + collectionId;
    this.http.get(url, this.options).subscribe(
      response => {
        var results = new ObservableArray(response.json());
        if (results.length > 0) {
  ...
  public addCollectionPayment(collectionPayment: TrnCollectionPayment): void {
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollectionPayment/Add";
  ...
  public deleteCollectionPayment(id: number): void {
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollectionPayment/Delete/" + id;
    this.http.delete(url, this.options).subscribe(
      response => {
  ...
  public updateCollectionPayment(collectionPayment: TrnCollectionPayment): void {
    let url = "https://filbrokerwebsite-greentech-api.azurewebsites.net/api/TrnCollectionPayment/Update";
