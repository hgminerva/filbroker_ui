...
export class ProjectService {
    ...
    public addProject(project: MstProject, btnAddProject: Element): void {
        let url = "http://localhost:10136/api/MstProject/Add";
    ...
    public deleteProject(id : number) {
        let url = "http://localhost:10136/api/MstProject/Delete/" + id;
    ...
    public getProject(id : number) {
        ...
        let url = "http://localhost:10136/api/MstProject/Detail/" + id;
    ...
    public saveProject(project: MstProject): void {
        let url = "http://localhost:10136/api/MstProject/Save";
    ...
    public lockProject(project: MstProject): void {
        let url = "http://localhost:10136/api/MstProject/Lock";
        this.http.put(url, JSON.stringify(project), this.options).subscribe(
            response => {
    ...
    public unlockProject(project: MstProject): void {
        let url = "http://localhost:10136/api/MstProject/Unlock";
        this.http.put(url, JSON.stringify(project), this.options).subscribe(
            response => {
    ...
    public saveHouseModel(houseModel: MstHouseModel): void {
        if(houseModel.id == 0) {
            let url = "http://localhost:10136/api/MstHouseModel/Add";
            ...
            let url = "http://localhost:10136/api/MstHouseModel/Save";
    ...
    public deleteHouseModel(id: number) {
        let url = "http://localhost:10136/api/MstHouseModel/Delete/" + id;
        this.http.delete(url, this.options).subscribe(
            response => {
