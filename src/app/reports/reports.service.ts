...
export class ReportsService {
    ...
    public getSoldUnitChecklistSummary(dateStart: string, dateEnd: string): void {
        let url = "http://filbrokerwebsite-priland.azurewebsites.net/api/RepSummary/ListSoldUnitChecklistPerDates/" + dateStart + "/" + dateEnd;
    ...
    public getCustomerList(dateStart: string, dateEnd: string): void {
        let url = "http://filbrokerwebsite-priland.azurewebsites.net/api/RepSummary/ListCustomerFilterByUpdateDateTime/" + dateStart + "/" + dateEnd;
    ...
    public getBrokerList(dateStart: string, dateEnd: string): void {
        let url = "http://filbrokerwebsite-priland.azurewebsites.net/api/RepSummary/ListBrokerFilterByUpdateDateTime/" + dateStart + "/" + dateEnd;
